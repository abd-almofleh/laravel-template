<div {{ $attributes->merge(['class' => 'article']) }}>
  <a class="article_featured-image" href="{{ $blog->pageUrl }}"><img class="blur-up lazyload"
         data-src="{{ $blog->photo->url }}" src="{{ $blog->photo->preview }}" alt="It's all about how you wear"></a>
  ...
  <p><a href="{{ $blog->pageUrl }}" class="btn btn--primary btn--small">{{ __('frontend/default.general.read_more') }}
