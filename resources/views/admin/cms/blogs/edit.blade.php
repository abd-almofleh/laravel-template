...
@section('content')
  <form method="POST" action="{{ route('cms.blogs.update', $blog) }}" enctype="multipart/form-data">
    @csrf()
    @method('PUT')
                ...
                <div class="col-md-12">
                  ...
                  <div class="form-group">
                    ...
                    <select type="text" name="status" id="status"
                      ...
                      <option value="1" @if (old('status', $blog->status) == 1) selected @endif>
                        {{ __('default.form.published') }}</option>
                      <option value="0" @if (old('status', $blog->status ?? 0) == 0) selected @endif>
            ...
            <div class="card-body">
              <div class="row">
                <div class="col-12">
                  ...
                  <div class="form-group">
                    <label for="slug_ar">{{ __('default.form.slug_ar') }}:</label>
                    <input type="text" name="slug_ar" id="slug_ar" dir="rtl"
                           class="form-control @error('slug_ar') form-control-error @enderror"
                  ...
                  <div class="form-group">
                    ...
                    <textarea name="description_ar" id="description_ar" rows="20"
                              class="form-control @error('description_ar') form-control-error @enderror">{{ old('description_ar', $blog->description_ar) }}</textarea>
            ...
            <div class="card-body">
              <div class="row">
                <div class="col-md-12">
                  ...
                  <div class="form-group">
                    <label for="slug_en">{{ __('default.form.slug_en') }}:</label>
                    <input type="text" name="slug_en" id="slug_en"
                           class="form-control @error('slug_en') form-control-error @enderror"
                  ...
                  <div class="form-group">
                    ...
                    <textarea name="description_en" id="description_en" rows="20"
                              class="form-control @error('description_en') form-control-error @enderror">{{ old('description_en', $blog->description_en) }}</textarea>
                ...
                <div class="col-md-12">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="meta_title_ar" id="meta_title_ar"
                           value="{{ old('meta_title_ar', $blog->meta_title_en) }}">
                  ...
                  <div class="form-group">
                    ...
                    <textarea name="meta_description_en" id="meta_description_en" class="form-control" rows="10">{{ old('meta_description_en', $blog->meta_description_en) }}</textarea>
                  ...
                  <div class="form-group">
                    ...
                    <textarea name="meta_description_ar" id="meta_description_ar" class="form-control" rows="10">{{ old('meta_description_ar', $blog->meta_description_ar) }}</textarea>
    ...
    Dropzone.options.photoDropzone = {
      ...
      init: function() {
        @if (isset($blog) && $blog->photo)
          const file = {!! json_encode($blog->photo->toArray()) !!}
