...
@section('content')
  <form method="POST" action="{{ route('horses.types.store') }}">
    @csrf()
          ...
          <div class="col-md-9">
            ...
            <ul class="breadcrumb">
              ...
              <li class="breadcrumb-item active-breadcrumb">
                <a href="{{ route('horses.types.create') }}">{{ __('horsesType.create.title') }}</a>
              </li>
            </ul>
          </div>
          <div class="col-md-3">
        ...
        <div class="col-md-12">
          ...
          <div class="card">
            <div class="card-header">
              <h5 class="card-title"> {{ __('horsesType.create.header') }} </h5>
            </div>
