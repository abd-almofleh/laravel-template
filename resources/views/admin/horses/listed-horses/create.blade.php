                ...
                <div class="col-md-12">
                  ...
                  <div class="form-group">
                    ...
                    <select type="text" name="sex" id="sex"
                      ...
                      <option value="1" @if (old('sex') == 1) selected @endif>
                        {{ __('default.sex.male') }}</option>
                      <option value="0" @if (old('sex') == 0) selected @endif>
                  ...
                  <div class="form-group">
                    <label for="contact_number" class="required">{{ __('default.form.contact_number') }}: (9715XXXXXXXX)</label>
