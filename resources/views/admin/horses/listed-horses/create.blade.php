...
@section('page_title')
  {{ __('horsesPassport.create.title') }}
@endsection
...
@section('content')
  <form method="POST" action="{{ route('horses.passports.store') }}">
    @csrf()
          ...
          <div class="col-md-6">
            ...
            <ul class="breadcrumb">
              ...
              <li class="breadcrumb-item active-breadcrumb">
                <a href="{{ route('horses.passports.create') }}">{{ __('horsesPassport.create.title') }}</a>
              </li>
            </ul>
          </div>
          <div class="col-md-3">
