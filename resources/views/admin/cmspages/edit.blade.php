          ...
          <div class="col-md-6">
            ...
            <ul class="breadcrumb">
              ...
              <li class="breadcrumb-item active-breadcrumb">
                <a href="{{ route('cmspages.edit', $cmspage->id) }}">{{ __('cms.edit.title') }} -
                  ({{ $cmspage->title }})</a>
              </li>
            </ul>
          </div>
                ...
                <div class="col-md-12">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="title" id="title"
                           class="form-control @error('title') form-control-error @enderror" required="required"
                           value="{{ $cmspage->title }}">
                  ...
                  <div class="form-group">
                    ...
                    <select type="text" name="cms_category_id" id="cms_category_id"
                      ...
                      @foreach ($cmscategories as $cmscategory)
                        <option value="{{ $cmscategory->id }}" @if ($cmspage->cat_id == $cmscategory->id) selected @endif>
                          {{ $cmscategory->name }}</option>
                      @endforeach
                    </select>
                  ...
                  <div class="form-group">
                    ...
                    <textarea name="description" id="description" class="form-control @error('description') form-control-error @enderror"
                              rows="20">{{ $cmspage->description }}</textarea>
                ...
                <div class="col-md-12">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="meta_title" id="meta_title"
                           value="{{ $cmspage->meta_title }}" required>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="meta_keywords" id="meta_keywords"
                           value="{{ $cmspage->meta_keywords }}" required>
