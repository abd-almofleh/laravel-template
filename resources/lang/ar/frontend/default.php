...
return [
  ...
  'general' => [
    ...
    'who_are_we_title'         => 'أمتطي صهوة الأدهم لتبدأ المغامرة',
    'who_are_we'               => 'سيجري بك الأدهم بسرعة الريح منطلقاً من خط البداية ويعبر بك كل المحطات، لتختار الخيل المميز والفريد، وتحصل على تدريبٍ مناسبٍ له ليشارك في سباقات القدرة والتحمل، وفارسٍ مغوارٍ يقوده إلى خط النهاية متوّجاً بالانتصارات.',
    'view_all'                 => 'مشاهدة الكل',
    'blogs_about_horses'       => 'كل شي عن الأحصنة',
    'close_menu'               => 'اغلاق',
