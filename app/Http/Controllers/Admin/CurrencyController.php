...
class CurrencyController extends Controller
{
  public function __construct()
  {
    ...
    $this->middleware('permission:currency-list,admin', ['only' => ['index', 'store']]);
    $this->middleware('permission:currency-create,admin', ['only' => ['create', 'store']]);
    $this->middleware('permission:currency-edit,admin', ['only' => ['edit', 'update']]);
